...
async def eth_gettransactionbyblockhashandindex(
    chain: str, param1: str, param2: str
) -> CallToolResult:
    try:
        return _ok(
            await client.eth_gettransactionbyblockhashandindex(chain.lower(), param1, param2)
        )
    except Exception as e:
        return _err(str(e))
...
async def eth_gettransactionbyblocknumberandindex(
    chain: str, param1: str, param2: str
) -> CallToolResult:
    try:
        return _ok(
            await client.eth_gettransactionbyblocknumberandindex(chain.lower(), param1, param2)
        )
    except Exception as e:
        return _err(str(e))
