...
class SolanaAdapter(BlockchainAdapter):
    ...
    async def getminimumbalanceforrentexemption(self, param1) -> str:
        return await self.rpc_client.post("getMinimumBalanceForRentExemption", [param1], self.rpc_url)
    ...
    async def gettokenaccountsbyowner(self, param1, param2, param3) -> str:
        return await self.rpc_client.post("getTokenAccountsByOwner", [param1, param2, param3], self.rpc_url)
